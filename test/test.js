...
describe('Some simple tests', ()=>{
  ...
  describe('simple npm deps', ()=>{

    describe('should correctly point exact deps', ()=>{
      const exactTests = [{
        key: 'bluebird',
        value: '3.5.2',
      }];
